...
public class ConstantAccessBenchMark {
  ...
  private static final MostlyConstant<Integer> MOSTLY_CONSTANT_INT =
  ...
  private static final MostlyConstant<Integer> MOSTLY_CONSTANT_INTEGER =
      new MostlyConstant<>(1_000, Integer.class);
  private static final Supplier<Integer> MOSTLY_CONSTANT_INTEGER_GETTER =
      MOSTLY_CONSTANT_INTEGER.getter();
  ...
  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder().include(ConstantAccessBenchMark.class.getName()).build();
    new Runner(opt).run();
  }
}
